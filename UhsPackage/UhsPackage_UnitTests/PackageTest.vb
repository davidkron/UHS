...
Imports Cycles.UhsPackage

Namespace UhsPackage_UnitTests
    <TestClass()> _
    Public Class PackageTest
        <TestMethod()> _
        Public Sub CreateInstance()
            Dim package As UhsPackagePackage = New UhsPackagePackage()
        End Sub
        ...
        Public Sub SetSite()
            ' Create the package
            Dim package As IVsPackage = TryCast(New UhsPackagePackage(), IVsPackage)
